...
apiRouter.post("/validate-email", authCtrl.validateEmail);
apiRouter.post("/auth/email/validate", authCtrl.validateEmail);
apiRouter.get("/auth/validate-email", authCtrl.validateEmail);
apiRouter.get("/validate-email", authCtrl.validateEmail);
apiRouter.post("/auth/check-email", authCtrl.checkEmail);
apiRouter.post("/check-email", authCtrl.checkEmail);
apiRouter.get("/auth/check-email", authCtrl.checkEmail);
apiRouter.get("/check-email", authCtrl.checkEmail);
...
apiRouter.post("/check-phone", authCtrl.checkPhone);
apiRouter.get("/auth/check-phone", authCtrl.checkPhone);
apiRouter.get("/check-phone", authCtrl.checkPhone);
...
apiRouter.post("/send-otp", authCtrl.sendOtp);
apiRouter.post("/auth/verify-otp", authCtrl.verifyOtp);
apiRouter.post("/verify-otp", authCtrl.verifyOtp);
apiRouter.post("/auth/forgot-password/send-otp", authCtrl.forgotPasswordSendOtp);
apiRouter.post("/forgot-password/send-otp", authCtrl.forgotPasswordSendOtp);
apiRouter.post("/auth/forgot-password/reset", authCtrl.forgotPasswordReset);
apiRouter.post("/forgot-password/reset", authCtrl.forgotPasswordReset);
apiRouter.get("/auth/me", authenticateJwt, authCtrl.getMe);
apiRouter.get("/me", authenticateJwt, authCtrl.getMe);
