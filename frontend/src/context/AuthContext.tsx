    ...
    try {
      ...
      if (parsed.ok && parsed.data?.success && parsed.data?.user) {
        ...
        const finalUser: UserData = {
          ...
          role: "WORKER",
          district: backendUser.district || data.district || "",
          pincode: backendUser.pincode || data.pincode || "",
        ...
        try {
          ...
          filteredWorkers.unshift({
            ...
            societyName: data.selectedSociety || data.societyName || (data.district ? `${data.district} Primary Labour Co-op Society` : "Cooperative Labour Society"),
