  ...
  return (
    <div className="min-h-screen bg-slate-50 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto space-y-8">
        {/* Header Strip */}
        <div className="bg-gradient-to-r from-teal-950 via-slate-900 to-teal-950 text-white p-8 rounded-3xl shadow-xl space-y-4 text-center sm:text-left flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <Link
            to="/demo"
            className="bg-gradient-to-r from-amber-400 to-amber-500 hover:from-amber-300 hover:to-amber-400 text-slate-950 font-black px-6 py-3.5 rounded-2xl shadow-lg transition flex items-center gap-2 text-sm flex-shrink-0"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {criteria.map((c, idx) => (
            <div
              key={idx}
              className="bg-white p-6 rounded-3xl border border-slate-200 shadow-xs hover:shadow-md transition space-y-2"
            >
        ...
        <div className="bg-white p-8 rounded-3xl border border-slate-200 shadow-xs flex flex-wrap items-center justify-between gap-4">
          <div>
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/architecture"
              className="px-5 py-3 rounded-xl border border-slate-300 hover:bg-slate-50 text-slate-800 font-bold text-xs transition flex items-center gap-1.5"
            >
              <Layers className="w-4 h-4" /> System Architecture Diagram
            </Link>
